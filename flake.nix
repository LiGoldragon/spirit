{
  ...
  inputs = {
    ...
    signal-spirit-judge-source = {
      url = "github:LiGoldragon/signal-spirit-judge/8f24ff2198a8";
      flake = false;
    };
          ...
          pkgs.runCommand "spirit-source-with-local-schema-patches"
            ...
            ''
              ...
              substituteInPlace $out/Cargo.toml \
                ...
                --replace-fail 'signal-spirit-judge = { git = "https://github.com/LiGoldragon/signal-spirit-judge.git", rev = "8f24ff2198a8", optional = true }' 'signal-spirit-judge = { path = "vendor-sources/signal-spirit-judge", optional = true }' \
