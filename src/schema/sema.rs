...
pub mod family_identity {
    pub const RECORDS_FAMILY: [u8; 32] = [
        233, 88, 40, 251, 202, 165, 243, 158, 178, 206, 219, 154, 217, 122, 18, 128, 35,
        156, 125, 179, 133, 120, 84, 95, 126, 125, 34, 169, 134, 70, 127, 110,
    ];
    pub const REFERENTS_FAMILY: [u8; 32] = [
        59, 31, 217, 119, 192, 51, 0, 231, 184, 226, 27, 216, 243, 155, 185, 14, 181,
        217, 16, 174, 156, 53, 105, 145, 174, 107, 88, 19, 140, 85, 162, 41,
    ];
    pub const MIGRATIONS_FAMILY: [u8; 32] = [
        228, 70, 160, 240, 231, 222, 95, 232, 59, 58, 251, 240, 240, 102, 46, 159, 17,
        55, 148, 112, 235, 201, 96, 222, 4, 90, 57, 243, 81, 184, 248, 52,
    ];
}
